    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden transition-all hover:shadow-lg">
      <div className="relative">
        ...
        <div className="absolute top-2 left-2 flex gap-1 items-center text-sm rounded px-2 py-1 dark:bg-gray-900/80 bg-gray-100/90">
          <span className={`font-medium ${alert.confidence > 0.8 ? 'text-red-500' : alert.confidence > 0.7 ? 'text-yellow-500' : 'text-gray-500'}`}>
      ...
      <div className="p-4">
        <div className="flex justify-between items-start mb-3">
          ...
          <div className={`flex items-center gap-1 ${getStatusBgColor()} px-2 py-1 rounded text-xs`}>
            {getStatusIcon()}
